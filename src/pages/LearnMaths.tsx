...
import LearnRelations from './LearnRelations';
import LearnTrigonometry from './LearnTrigonometry';
...
const LearnMaths = () => {
  ...
  if (topicId === 'relations-functions') {
    return <LearnRelations />;
  }

  if (topicId === 'trigonometry') {
    return <LearnTrigonometry />;
  }
  ...
  return (
    <AppLayout title="Coming Soon">
      <div className="p-4 pb-8 flex flex-col items-center justify-center min-h-[calc(100vh-56px)]">
        ...
        <Button onClick={() => navigate('/topics/maths')} className="gap-2">
